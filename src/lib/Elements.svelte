...
<div class="quickstart">
  ...
  <ul>
    ...
    <li>
      When you hit the Submit button, the new component will appear in the
      components menu. Click the component and it will appear in the canvas, as
      well as in file structure window.
    </li>
  </ul>
  ...
  <ul>
    ...
    <li>
      ...
      small black tab at the bottom right corner. To remove a component from the
  ...
  <ul>
    <li>
      To preview a components code, simply click on its box inside of the
      canvas, and the code block will update (remember that the entire canvas
      defaults to Index.svelte).
    </li>
  </ul>
</div>
<br />
